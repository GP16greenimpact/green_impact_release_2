...
class GrainsAndSeeds extends StatefulWidget {
  @override
  _GrainsAndSeedsState createState() => _GrainsAndSeedsState();
}

class _GrainsAndSeedsState extends State<GrainsAndSeeds> {
  var selected = 0;

  final List<Product> prodList = ProductListVeiw2.GAndS.toSet().toList();
