...
class Honey extends StatefulWidget {
  @override
  _HoneyState createState() => _HoneyState();
}

class _HoneyState extends State<Honey> {
  var selected = 0;

  final List<Product> prodList = ProductListVeiw2.Honey.toSet().toList();
  @override
